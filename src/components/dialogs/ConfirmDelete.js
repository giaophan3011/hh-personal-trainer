...
const ConfirmDelete = () => {
  ...
  return (
    ...
    <DialogContent>Do you want to delete {dialogTitle.includes("customer") ? ` customer ${objectToDelete.firstname} ${objectToDelete.lastname}` : `activity ${objectToDelete.activity}`}? Deletion cannot be undone</DialogContent>
      <DialogActions>
        <Button
          variant="contained"
          onClick={handleClose}
